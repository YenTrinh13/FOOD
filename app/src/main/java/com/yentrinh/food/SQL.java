...
public class SQL extends SQLiteOpenHelper {
    ...
    public void onCreate(@NonNull SQLiteDatabase db) {
        ...
        db.execSQL(sql);
        sql = "INSERT INTO TaiKhoan VALUES ('dinhon910', '123456','Phan Nguyễn Duy Nhân','09/10/2001','Cửa sổ Topaz','abc@gmail.com', null)";
        db.execSQL(sql);
        sql = "INSERT INTO TaiKhoan VALUES ('beho1603', '123456','Lưu Văn Hòa','16/03/2001','ToPaz','abc@gmail.com', null)";
        db.execSQL(sql);
        // them bang mon an
