...
public class Suamonan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edCheckKieng = (CheckBox) findViewById(R.id.checkBox_suaChay) ;
        edCheckChay = (CheckBox) findViewById(R.id.checkBox_suaMan) ;
        edCheckMan = (CheckBox) findViewById(R.id.checkBox_suaKieng) ;
